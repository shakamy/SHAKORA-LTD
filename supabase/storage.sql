...
drop policy if exists public_portfolio_media_read on storage.objects;
...
drop policy if exists admin_portfolio_media_insert on storage.objects;
drop policy if exists admin_portfolio_media_update on storage.objects;
drop policy if exists admin_portfolio_media_delete on storage.objects;
